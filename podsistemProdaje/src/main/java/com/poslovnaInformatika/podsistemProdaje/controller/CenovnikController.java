...
//	private StavkaCenovnikaService stavkaCenovnikaService;
	...
	public ResponseEntity<Void> dodajCenovnik(@Validated @RequestParam("datum_vazenja") String datumVazenja,@RequestParam("preduzece") String nazivPreduzeca ) throws java.text.ParseException{
	...
	public ResponseEntity<Void> izmeniCenovnik(@RequestParam("id") Long id,@RequestParam("datum_vazenja") String datumVazenja,@RequestParam("preduzece") String nazivPreduzeca){
	...
	@DeleteMapping(value="/obrisiCenovnik/{id}")
	public ResponseEntity<Void> obrisiCenovnik(@RequestParam Long id){
		Cenovnik cenovnik=cenovnikService.findOne(id);
		if(cenovnik ==null) {
			return new ResponseEntity<Void>(HttpStatus.BAD_REQUEST);
		}
		cenovnikService.remove(cenovnik.getIdCenovnika());
		System.out.println("Obrisan cenovnik sa id-jem"+cenovnik.getIdCenovnika());
		return new ResponseEntity<Void>(HttpStatus.OK);
